	...
	<div class="header">
		<div class="container">
				<div class="header-top">
					<div class="logo">
                                            <h1><a href="admin_home.php">Auto-Repair</a></h1>
					</div>
					<div class="phone">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						  <ul class="nav navbar-nav cl-effect-16">
							  ...
							  <ul class="dropdown-menu">
                                                              ...
                                                              <li><a href="org_enq.php">Parking Station</a></li>
                                                              <li><a href="local_enq.php">Local Station</a></li>
							  ...
							  <ul class="dropdown-menu">
                                                              ...
                                                              <li><a href="park_view.php">Parking Station</a></li>
                                                              <li><a href="local_view.php">Local Station</a></li>
