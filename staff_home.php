			...
			<div class="container">
					...
					<div class="welcome-grids">
						...
						<div class="col-md-6 welcome-grid1">
                            ...
                            $e=mysql_query("select * from r_van where uid='$a'");
                         
                            if($f=mysql_fetch_row($e))
                            {
                            
                            
                            ?>
                    <div class="desc">Recovery Van:<?php echo $f['1']?></div>
                    ...
                    <?php
							...
							<table class="table table-responsive ">
                                                ...
                                                <tr>
                                                    <td colspan="2"><center><input type="submit" name="sub" value="Add/Update Now" class="btn btn-success" /></center></td>
                                                </tr>
                                            </table>
