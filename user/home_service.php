...
<?php
     ...
     mysql_query("insert into s_help values('','$la','$lo','$usr','$r[1]','$r[5]','$t1','$r1[13]','$date','0')");
    
    if(mysql_affected_rows()>0)
{
 header("location:home_service.php?cid=$mid&suss=1");
}
		...
		<div class="typography">
			<!-- container-wrap -->
             ...
             <?php
                            ...
                            $vt="select con from r_van where uid='$mid'";
                            $vt1=mysql_query($vt);
                            ...
                            {         
                                            ...
                                            <h4> <center>Recovery Van: <span style="color: green">Available</span></center></h4>
 ...
 ?>
                            ...
                            if($vt2=="Not Available")
                            {
                            ?>
                                            <h4>  <center>Recovery Van: <span style="color: red">Not Available</span></center></h4>
                                  <?php
                            }
                            }
                            ?> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="t1"class="form-control">
                                                            ...
                                                            <option value="Periodic Repair">Periodic Repair</option>
